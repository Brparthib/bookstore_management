...
# class BookListView(generics.ListCreateAPIView):  # Get, Post request
#     queryset = BookStoreModel.objects.all()
#     serializer_class = BookStoreSerializer


# # Update, Delete and Access Single Element
# class BookListUpdateDelete(generics.RetrieveUpdateDestroyAPIView):
#     queryset = BookStoreModel.objects.all()
#     serializer_class = BookStoreSerializer
